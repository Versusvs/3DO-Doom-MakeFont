...
static char RezFileName[32] = "SmallFont";
...
///		MainPtr->Count = Count;
	...
	MyHeader.MemSize = ((Byte *)MainPtr)-Buffer-12;
}
...
///			j = MainPtr->Count;		/* Get the run count */
			j = MyCount; 
//			printf("# MainPtr->Count %s\n", &j);
/////			j = RezCount;		/* Get the run count */
...
//	printf("# Saving %s\n",&MyHeader);
	...
	printf("# Saving font file %s\n",0);
	fwrite(Buffer,1,Length,outfp); /* All File Headers ///////////////////////////////////////////////////////////////////////////////////////////////// */
...
//#if 0
	...
	if (Length) {		/* Any data to copy? */
		do {
			...
			fwrite(Buffer,1,Chunk,outfp); /* All files together //////////////////////////////////////////////////////////////////////////////////////////////////////////// */
			Length -= Chunk;
		} while (Length);
	}
#endif
...
argc=2;
    ...
    fp = fopen("FontScript.txt","r");    /* Read the ASCII script */
	if (!fp) {
